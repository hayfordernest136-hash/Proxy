  ...
  return (
    <a
      ...
      className={cn(
        ...
        "rounded-full bg-[#25D366] p-3.5 shadow-lg",
    ...
    >
      ...
      <span
        className={cn(
          ...
          "whitespace-nowrap rounded-lg bg-foreground px-3 py-1.5 text-xs font-medium text-background",
      ...
      {/* WhatsApp SVG icon */}
      <svg viewBox="0 0 24 24" fill="white" className="size-6 sm:size-7" aria-hidden="true">
